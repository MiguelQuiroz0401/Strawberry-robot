    ...
    while True:
        ...
        if depth_frame is not None:
            ...
            if left_distance_smooth < DISTANCE_THRESHOLD or right_distance_smooth < DISTANCE_THRESHOLD:
                set_mode(vehicle, "MANUAL")  # Cambiar a modo MANUAL para esquivar
                ...
                set_mode(vehicle, "GUIDED")  # Regresar a modo GUIDED
...
def main():
    ...
    set_mode(vehicle, "GUIDED")  # Iniciar en modo GUIDED
    send_pwm_to_rc3(vehicle, STEERING_NEUTRAL)  # Estado neutral
